...
class FriendRequests extends StatefulWidget  {
  ...
  static String _onnull;
  FriendRequests(this._currentUsername);
...
class _FriendRequestsState extends State<FriendRequests> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream:  _regesterfirebase.child("users/userdetails/"+widget._currentUsername.toString()+"/friendrequest").onValue,
      ...
      if (snap.hasData && !snap.hasError && snap.data.snapshot.value != null) {
        ...
        return ListView(
                         children:_friendrequests.map((e)
                         {
                          ...
                          child: AnimNewFriendRequestAnimation(e.toString(),widget._currentUsername,_settingup)
                          );
                         }).toList()
                       );
